...
describe('OidcManager', () => {
  ...
  describe('initRs()', () => {
    it('should initialize a Resource Authenticator instance', () => {
      const servererUri = 'https://localhost:8443'
      const authCallbackUri = servererUri + '/api/oidc/rp'
      const postLogoutUri = servererUri + '/goodbye'
      ...
      expect(oidc.rs.defaults.realm).to.equal(servererUri)
